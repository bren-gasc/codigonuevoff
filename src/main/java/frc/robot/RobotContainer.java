...
// The robot's subsystems and commands are defined here...
  ...
  public final Brazo brazo = new Brazo();

  
  public static final XboxController Joystick1 = new XboxController(Constants.JOYID1);
  public static final XboxController Joystick2 = new XboxController(3);
  public static final XboxController ControlGarra = new XboxController(Constants.ControlGarraID);
  ...
  public RobotContainer() {
   ...
   JoyChassis = new ChassisJoysticks(drivetrain, () -> Joystick2.getLeftY(), () -> Joystick2.getRightX());
  ...
  private void configureBindings() {
    ...
    Sbutton.whileTrue(new MoveEncoder(brazo, true));
    Sbutton.whileFalse(new MoveEncoder(brazo, false));

    // Garra llantas {
    JoystickButton Y = new JoystickButton(ControlGarra, XboxController.Button.kY.value);
    Y.whileTrue(new Llantas(intake, 0.6));
